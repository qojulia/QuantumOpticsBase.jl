@testitem "Fock Distribution Plotting" tags=[:plotting] begin
    ...
    @testset "unit_y_range toggled off" begin
        fig, _, _ = fockdistributionplot_axis(coherentstate(b, 2.0); unit_y_range=false)
        save("test_fock_freey.png", fig)
        @test isfile("test_fock_freey.png")
        rm("test_fock_freey.png")
    end
